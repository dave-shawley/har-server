...
def entry_point():
    ...
    # Give our yaml files a mime-type, this affects the Content-Type
    # generated by the static file handler
...
def _create_app(opts):
    ...
    static_dir = pkg_resources.resource_filename(__package__, 'static')
    app.add_routes([
        aiohttp.web.get('/', docs.handler),
        aiohttp.web.static('/static', static_dir, append_version=True),
    ])
    return app
